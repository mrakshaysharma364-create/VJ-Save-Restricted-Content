...
API_ID = int(os.environ.get("API_ID", "5823644045"))

# Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "3b1d64ecacbf1e15199893f346f77323")

# Your Owner / Admin Id For Broadcast 
ADMINS = int(os.environ.get("ADMINS", "5823644045"))
...
DB_URI = os.environ.get("DB_URI", "mongodb+srv://akshaysharma6744ff_db_user:OzjIHO9iaEeAJgMb@cluster0.pjtyzos.mongodb.net/?appName=Cluster0") # Warning - Give Db uri in deploy server environment variable, don't give in repo.
